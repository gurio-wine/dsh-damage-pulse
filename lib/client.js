								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: ["当前版本 v", updateStatus?.currentVersion ?? "0.3.2"]
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		*/
		...
		function useRouteEligibility(useSessions, load, bypass) {
			...
			(0, react.useEffect)(() => {
				...
				const controller = new AbortController();
				load(sessionId, controller.signal).then((next) => {
...
`;
		...
		function BalanceWidget({ previewOverride, loadRouteEligibility, useSessions }) {
			...
			const shouldPoll = routeEligible === true || previewOverride !== void 0;
			...
			if (previewOverride === void 0 && routeEligible !== true) return null;
		...
		*/
		...
		function isRouteEligible(response, pricing) {
			if (pricing === void 0 || pricing.provider !== "deepseek-official") return false;
		...
		function createRouteEligibilityLoader(sessions, fetcher = fetch) {
			return async (sessionId, signal) => {
				try {
					const [models, response] = await Promise.all([sessions.models({ sessionId }, signal), fetcher("/api/token-monitor/pricing-eligibility", {
						cache: "no-store",
						signal
					})]);
		...
		function apply(ctx) {
			const loadRouteEligibility = createRouteEligibilityLoader(ctx.get("connection").api.sessions);
